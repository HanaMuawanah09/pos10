...
<div class="container mt-3">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid px-0">
            <a class="navbar-brand" href="<?php echo e(Route::has('tentang') ? route('tentang') : url('/tentang')); ?>">
    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo SMKN 4">
    POS Hana
</a>
...
</html><?php /**PATH C:\laragon\www\pos9-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>